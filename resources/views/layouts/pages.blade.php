              ...
              <div class="row">
                ...
                <div class="col col-9">
                  <div class="col border shadow-sm">
                    <div style="font-size: 16px" class="bg-white col align-self-start">
                      &nbsp;
                      @yield('content')
                      &nbsp;
                    </div>
                ...
                <div class="col list-group" style="font-size: 16px">
                  ...
                  <a href="help-center" class="list-group-item list-group-item-action disabled">Help Center</a>
                  <a href="languages" class="list-group-item list-group-item-action disabled">Language</a>
                  <a href="career" class="list-group-item list-group-item-action disabled">Career</a>
                  <ul></ul>
                <div>
              </div>
            </div>
