        ...
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
            <div class="container col-10">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  @foreach ($users as $x)
                  <div>
                    <a class="dropdown-item" href="message-{{ $x->id}}">
                      <img class="profile-image" src="storage/images/newsfeeds/{{ $x->image}}" height="30" width="30">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            ...
                            <li>
                              <button class="login btn btn-light border" data-toggle="modal" href="#newmodel2"> Follow</button>
                            </li>
                                  ...
                                  <div class="modal-content">
                                    ...
                                    <form action="followers" method="POST">
                                      ...
                                      <div class="modal-header">
                                        ...
                                        <h5 class="modal-title" id="newmodell">Follow {{$u->first_name}} {{$u->last_name}} as</h5>
                                      ...
                                      <input type="hidden" name="person_id" value="{{ $u->id}}"></input>
                                      ...
                                      <div class="modal-footer">
                                        <button type="submit" class="btn btn-light login border">Follow</button>
                                      </div>
                                    </form>
                                    @endforeach
                                  </div>
