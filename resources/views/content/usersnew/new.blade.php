        ...
        <div role="tabpanel">
          ...
          <!-- Nav tabs -->
            ...
            <div class="tab-content">
                ...
                @include('content.usersnew.newpayments')

                @include('content.usersnew.newtransaction')

                @include('content.usersnew.newexchanges')

                @include('content.usersnew.newposts')

                @include('content.usersnew.newmail')
